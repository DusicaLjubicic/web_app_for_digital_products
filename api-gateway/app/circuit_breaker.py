...
class CircuitState(Enum):
    ...
    OPEN = "open"           # Servis nedostupan, odbija zahteve
    HALF_OPEN = "half_open" # Testira da li je servis oporavio

class CircuitBreaker:
    def __init__(self, failure_threshold: int = 3, recovery_timeout: int = 30):
        self.failure_threshold = failure_threshold  # Broj grešaka pre otvaranja
        self.recovery_timeout = recovery_timeout    # Sekundi pre pokušaja oporavka
...
# Instanca Circuit Breaker-a za svaki mikroservis
circuit_breakers = {
